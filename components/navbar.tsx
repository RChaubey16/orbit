...
export function Navbar() {
  return (
    <header className="w-full border-b border-zinc-100 bg-white">
      <div className="flex h-14 items-center px-4 sm:px-8 lg:px-12">
        ...
        <nav className="ml-auto flex items-center">
          <a
            ...
            className="p-2 text-zinc-500 hover:text-zinc-900 transition-colors rounded-md hover:bg-zinc-50"
            aria-label="GitHub"
          >
            <GitHubIcon />
          </a>
